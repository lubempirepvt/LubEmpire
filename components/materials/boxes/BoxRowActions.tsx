            ...
            <div className="px-6 py-5 flex justify-between items-center border-b border-gray-200/50">
              <div>
                ...
                <p className="text-xs text-gray-500 font-semibold mt-0.5">
                  {box.name} <span className="text-gray-300 mx-1">|</span> Stock: {Number(box.stock).toFixed(2)}
                </p>
              </div>
            ...
            <div className="p-6">
              <form onSubmit={handleAdjustSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input className={glassInput} type="number" step="1" name="quantity" min="1" max={adjustmentType === "Remove Quantity" ? box.stock : undefined} required />
                  {adjustmentType === "Remove Quantity" && <p className="text-[10px] text-red-500 mt-1 font-bold">* Max available: {box.stock}</p>}
                </div>

                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1.5 uppercase tracking-wide">Reason</label>
                  <input className={glassInput} type="text" name="reason" placeholder="e.g., Damaged box" />
                </div>
