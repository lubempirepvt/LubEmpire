...
import AddStickerModal from "@/components/materials/stickers/AddStickerModal";
...
export default async function StickersPage({
  ...
  const tab = resolvedParams.tab || "stickers";
  const pageSize = 20;
                  ...
                  {stickersData.length > 0 ? (
                    stickersData.map((sticker) => (
                      ...
                      >
                        ...
                        <td
                          className={`p-4 text-center font-bold ${sticker.stock <= 0 ? "text-red-500" : "text-green-600"}`}
                        >
                          {Number(sticker.stock).toFixed(0)}
                        </td>
                        <td className="p-4 text-right">
                          <StickerRowActions sticker={sticker} />
                        </td>
                      </tr>
                    ))
                  ) : (
        ...
        {tab === "stock-in" && (
          <>
            <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-white shrink-0">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <StickerStockInModal stickers={allStickers || []} />
              </div>
            </div>
